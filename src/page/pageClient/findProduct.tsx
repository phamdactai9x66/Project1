...
interface FindProductProp extends RouteComponentProps {
...
const FindProduct: React.FC<FindProductProp> = (props) => {
    ...
    let getname = (props.location.state as any).nameProduct
    useEffect(() => {
        (async () => {
            let save1 = { ...state.filter, name: getname }
            ...
            <div>
                ...
                <div>
                    <div className="flex-mindle" style={{ padding: '10px 0' }}>
                        ...
                        <p>result_searching <label id="result_searching">{getname}</label> </p>
